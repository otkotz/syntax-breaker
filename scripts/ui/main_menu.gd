...
const C_BG_1 := UITheme.C_BG_1
const C_PANEL_BG := UITheme.C_PANEL_BG

const C_V_DEEP := UITheme.C_V_DEEP
const C_V_BASE := UITheme.C_V_BASE
const C_V_MID := UITheme.C_V_MID
const C_V_BRIGHT := UITheme.C_V_BRIGHT
const C_V_GLOW := UITheme.C_V_GLOW
const C_V_LINE := UITheme.C_V_LINE
const C_V_LINE_D := UITheme.C_V_LINE_D

const C_SILVER := UITheme.C_SILVER
const C_SILVER_D := UITheme.C_SILVER_D
